...
const UneteCard = ({ img, title, description, cta}) => {
  return (
    <article className='bg-item rounded-xl mb-6 max-w-80 mx-auto lg:grid lg:grid-cols-cards'>
        <section className=''>
        ...
        <section className='lg:text-start lg:px-4 lg:place-self-center'>
            ...
            <p className='text-title font-semibold text-sm px-8 mb-5 sm:text-base lg:px-0 lg:pr-20'>{description}</p>
